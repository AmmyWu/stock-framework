...
public class RedisServiceImpl extends RedisService {
	...
	/** 查询Hash缓存的服务方法 */
	private com.stock.service.base.cache.impl.RedisHashServiceImpl redisHashServiceImpl;
	
	/** 查询List缓存的服务方法 */
	private RedisListServiceImpl redisListServiceImpl;
	
	/** 查询Object缓存的服务方法 */
	private com.stock.service.base.cache.impl.RedisObjectServiceImpl redisObjectServiceImpl;
	...
	public RedisServiceImpl(
		...
		redisHashServiceImpl = new com.stock.service.base.cache.impl.RedisHashServiceImpl(redisTemplate,customStringRedisTemplate);
		redisListServiceImpl = new RedisListServiceImpl(redisTemplate,customStringRedisTemplate);
		redisObjectServiceImpl = new com.stock.service.base.cache.impl.RedisObjectServiceImpl(redisTemplate,customStringRedisTemplate);
