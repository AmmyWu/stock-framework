package com.blsb.webapp.base.log;
...
public class AspectForLog {
	...
	@Around("execution(* com.blsb.service.*.impl.*ServiceImpl.delet*(..))"
			+"||execution(* com.blsb.service.*.impl.*ServiceImpl.insert*(..))"
			+"||execution(* com.blsb.service.*.impl.*ServiceImpl.save*(..))"
			+"||execution(* com.blsb.service.*.impl.*ServiceImpl.update*(..))"
			+"||execution(* com.blsb.service.*.impl.*ServiceImpl.refresh*(..))")
