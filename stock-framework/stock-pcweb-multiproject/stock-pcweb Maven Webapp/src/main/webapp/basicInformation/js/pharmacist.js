        ...
        user_tb = $("#user_tb").DataTable(
            {
                ...
                columns: [
                    ...
                    { title: "药师工号", data: "pharmacist_key" },
                    { title: "药师姓名", data: "pharmacist_name" },
                    { title: "药师职称", data: "pharmacist_prof" },
                    { title: "药师职级", data: "pharmacist_level" },
                    { title: "调剂权", data: "adjust_permit" },
                    { title: "按时注册", data: "register_flag" },
                    { title: "抗菌药物处方调剂权", data: "antibiotics_flag" },
