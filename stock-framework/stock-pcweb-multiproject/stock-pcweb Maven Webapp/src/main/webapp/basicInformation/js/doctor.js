        ...
        user_tb = $("#user_tb").DataTable(
            {
                ...
                columns: [
                    ...
                    { title: "医院名称", data: "hosp_key" },
                    { title: "医院类别", data: "hosp_kind" },
                    { title: "科室", data: "depart_key" },
                    { title: "医生工号", data: "doctor_key" },
                    { title: "医生姓名", data: "doctor_name" },
                    { title: "医生职称", data: "doctor_prof" },
                    { title: "医生职级", data: "doctor_level" },
                    { title: "处方权", data: "recipe_permit" },
                    { title: "按时注册", data: "register_flag" },
                    { title: "印鉴卡", data: "signature_card" },
                    { title: "开具抗菌药物权", data: "antibiotics_flag" },
                    { title: "最后修改人", data: "amender" },
                    { title: "最后修改时间", data: "amender_time" }],
                columnDefs: [
                    {
                        orderable: false,
                        targets: 0
